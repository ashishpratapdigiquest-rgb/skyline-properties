...
export const metadata = { title: "Our Services | Skyline Properties Gorakhpur", description: "Buying, selling, renting aur property management services in Gorakhpur, Uttar Pradesh." };
